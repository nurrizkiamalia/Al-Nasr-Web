    ...
    <>
      <ContentContainer className=" w-full flex flex-col items-end gap-10 px-10  py-[50px] xl:p-[100px] ">
        <div className=" w-full gap-5 flex flex-col-reverse lg:flex-row lg:justify-between lg:items-end">
            <Button className=" w-fit flex gap-3 items-center"> <FaArrowLeftLong /> Previous</Button>
        ...
        <div className=" flex flex-col gap-5 self-start w-full ">
          <div className="airways relative flex flex-col items-center lg:flex-row overflow-x-auto py-2 gap-5 lg:gap-10 ">
            <div className="flex flex-col md:flex-row flex-nowrap gap-10">
              <TestimonialBox />
            </div>
          </div>
          <div className="airways hidden relative lg:flex flex-col items-center lg:flex-row overflow-x-auto  py-2 gap-5 lg:gap-10 ">
        ...
        <div className="flex justify-end">
            <Button className="flex w-fit gap-3 items-center" > Next <FaArrowRightLong /></Button>
        </div>
      </ContentContainer>
    </>
  );
