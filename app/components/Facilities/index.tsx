...
const Facilities: React.FC = () => {
    return(
        <>
        <ContentContainer className="w-full bg-dspBgGreen flex flex-col items-center gap-10 py-[100px] " id="facilities">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-10">
                {facilitiesdata.map((item, index) => (
                    <div key={index} className="facility flex gap-5 p-5 items-start bg-white shadow-shadow1 shadow-gray-300 rounded-xl">
